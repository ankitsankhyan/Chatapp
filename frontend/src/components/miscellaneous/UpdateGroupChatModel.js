...
import {
  ...
  import { Button , Box, Input,FormControl} from '@chakra-ui/react';
...
const UpdateGroupChatModel = ({fetchAgain,setFetchAgain}) => {
    ...
    const handleRemove = async(user1)=>{
      console.log(user.data, selectedChat.groupAdmin, user1);
    ...
    const handleAddUser=async(user1)=>{
      if (selectedChat.users.find((u) => u._id === user1._id)) {
       ...
       console.log(selectedChat , user, 'is selected Chat ++++++++++++++++++++++++++++++++');
